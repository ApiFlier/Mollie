...
#
# Usage:
#   ./menu.sh  →  [7] Advanced tools  →  Seed workflow  →  [1] Refresh seed
#   scripts/commands/update-seed.sh           # interactive — asks before writing
#   scripts/commands/update-seed.sh --yes     # noninteractive — skips confirmation prompt
#
# What this does:
