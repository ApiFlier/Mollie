...
# scripts/commands/update-seed.sh) to review and push the updated seed.
#
# Usage:
#   ./menu.sh  →  [7] Advanced tools  →  Seed workflow  →  [3] Publish
...
# Resolve repo root regardless of where this script lives.
...
info "Repo root confirmed: $APP_DIR"
